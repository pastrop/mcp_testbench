...
Usage:
    uv run long_running_agent/viz/ui_designer.py path/to/harness_output.json \
...
def main() -> int:
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent("""\
            examples:
              ...
              # Save to a specific path (default: long_running_agent/viz/generated/dashboard_<timestamp>.html)
              uv run long_running_agent/viz/ui_designer.py long_running_agent/harness_output.json \\
                  -o /tmp/dash.html
        """),
    )
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "long_running_agent/viz/generated/dashboard_<timestamp>.html"
        ),
    )
    parser.add_argument(
        "--model",
    ...
    annotation = textwrap.dedent(f"""\
        <!--
            Generated by long_running_agent/viz/ui_designer.py
